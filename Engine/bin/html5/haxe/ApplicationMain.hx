...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Engine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "41";
		app.meta["company"] = "Sergiosoba";
		app.meta["file"] = "Engine";
		app.meta["name"] = "Engine";
		app.meta["packageName"] = "com.sergiosoba.engine";
